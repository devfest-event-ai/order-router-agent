...
st.markdown('<p class="tagline">Messy In → Structured Out → Running Without You</p>', unsafe_allow_html=True)
st.markdown("---")
...
with tab3:
    ...
    st.markdown("---")
    st.caption("""
    Built for Skayl AI & Automations Engineer application  
    Demonstrates: Messy In → Structured Out → Running Without You  
    """)
...
st.markdown("📦 Order Router Agent | Built with FastAPI + Groq + Streamlit")